...
app.set("port", process.env.PORT || 3500); //Si hay una variable de entorno PORT con un valor especifico, tomelo, de lo contrario tome el 3000
app.set("views", path.join(__dirname, "views")); //Se define la ruta de las vistas, carpeta views
...
// routes
app.use("/", indexRoutes); //Inicia por la ruta de la raiz 
